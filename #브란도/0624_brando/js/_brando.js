  ...
  var brando = {
    ...
    section09Fn: function () {
      ...
      function resizeFn() {
        ...
        switch (idx) {
          case 0: //ALL 8개
            ...
            if (cols == 4) {
              ...
              $('#section09 .gallery-item').eq(0).stop().show().animate({
                left: imgW * 0,
                top: imgH * 0
              });
              $('#section09 .gallery-item').eq(1).stop().show().animate({
                left: imgW * 1,
                top: imgH * 0
              });
              $('#section09 .gallery-item').eq(2).stop().show().animate({
                left: imgW * 2,
                top: imgH * 0
              });
              $('#section09 .gallery-item').eq(3).stop().show().animate({
                left: imgW * 3,
                top: imgH * 0
              });

              $('#section09 .gallery-item').eq(4).stop().show().animate({
                left: imgW * 0,
                top: imgH * 1
              });
              $('#section09 .gallery-item').eq(5).stop().show().animate({
                left: imgW * 1,
                top: imgH * 1
              });
              $('#section09 .gallery-item').eq(6).stop().show().animate({
                left: imgW * 2,
                top: imgH * 1
              });
              $('#section09 .gallery-item').eq(7).stop().show().animate({
                left: imgW * 3,
                top: imgH * 1
              });
        ...
        $('#section09 .gallery-container').css({
          height: imgH * rows
        }); //갤러리 전체박스 높이를 구함
